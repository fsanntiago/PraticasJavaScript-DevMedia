...
let tamanhoColecaoCuriosidade = curiosidades_chuck_norris.length;


let numeroAleatorio = Math.floor(Math.random() * tamanhoColecaoCuriosidade);

let curiosidade = curiosidades_chuck_norris[numeroAleatorio];

let curiosidadeTitulo = curiosidade.titulo;
let curiosidadeConteudo = curiosidade.conteudo;

console.log("CURIOSIDADE SOBRE CHUCK NORRIS \n" + "Titulo: " + curiosidadeTitulo + "\n" + "Conteudo: " + curiosidadeConteudo+ "\n");